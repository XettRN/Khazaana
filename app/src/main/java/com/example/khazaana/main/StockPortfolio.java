...
public class StockPortfolio extends Fragment {List<Map> t = null;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //these will have to be changed to Navigation. Refer to Clients.java
        stock1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getContext(), specific_equity.class));
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getContext(), crypto_portfolio.class));
            }
        });
