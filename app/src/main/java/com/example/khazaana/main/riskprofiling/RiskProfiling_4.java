...
public class RiskProfiling_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ChipGroup choiceChipGroup4 = findViewById(R.id.choice_chip_group_4);
        choiceChipGroup4.setOnCheckedChangeListener(new ChipGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(ChipGroup chipGroup, @IdRes int i) {
                ...
                for (int j = 0; j < chipGroup.getChildCount(); j++) {
                    ...
                    if (c.isChecked()) {
                        ...
                        RiskProfilingValues.setRisk_profiling_value4(String.valueOf(c.getText()));
                    }
                }
            }
        });
