...
public class RiskProfiling_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ChipGroup choiceChipGroup5 = findViewById(R.id.choice_chip_group_5);
        choiceChipGroup5.setOnCheckedChangeListener(new ChipGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(ChipGroup chipGroup, @IdRes int i) {
                ...
                for (int j = 0; j < chipGroup.getChildCount(); j++) {
                    ...
                    if (c.isChecked()) {
                        ...
                        RiskProfilingValues.setRisk_profiling_value5(String.valueOf(c.getText()));
                    }
                }
            }
        });
